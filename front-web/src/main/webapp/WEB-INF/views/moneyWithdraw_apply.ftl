...
<#if !hasWithdrawInProcess && bindBank>
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div>
					...
					<#elseif bindBank>
					<form id="editForm" class="form-horizontal el-form" action="/moneyWithdrawApply.json" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="form-control">${bankInfo.banknumber}</label>
							</div>
						</div>
						<div class="form-group">
