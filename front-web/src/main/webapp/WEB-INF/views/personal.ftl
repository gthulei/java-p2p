    ...
    $(function () {
      ...
      $("#sendVerifyCode").click(function () {
        ...
        if (phoneNumber) {
          $.ajax({
            type: "POST",
            url: "/sendVerifyCode.json",
            dataType: "json",
            data: { //发送到服务器的数据
              phoneNumber: phoneNumber
            },
            success: function (data) {
              if (data.succeed) { //做倒计时
                $.messager.popup(data.errorMessage);
                var count = 60;
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
			 <#assign currentMenu="personal" />
				<#include "base/leftmenu-tpl.ftl" /></div>
    <!-- 功能页面 -->
    <div class="col-sm-9">
        ...
        <div class="panel-body el-account">
          <div class="el-account-info">
            ...
            <div class="pull-left"
              ...
              class="btn btn-danger btn-lg" href="/moneyWithdraw">账户提现</a>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" id="bindEmailForm" method="post" action="/sendEmail.json">
            <div class="form-group">
