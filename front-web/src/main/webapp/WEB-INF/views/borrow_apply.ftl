...
<html>
	...
	<body>
		...
		<form class="form-horizontal el-borrow-form" id="editForm" novalidate="novalidate" method="post" action="/borrowApply.json">
				...
				<div class="form-group">
					...
					<label class="radio-inline">
						<input type="radio" value="0" checked="checked" name="bidrequesttype" />
						按月分期
					</label>
					<label class="radio-inline">
						<input type="radio" value="1" name="bidrequesttype" />
						按月到期
					</label>
				</div>
				<div class="form-group">
