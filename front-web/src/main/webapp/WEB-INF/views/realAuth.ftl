				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<form class="form-horizontal" id="realAuthForm" method="post" action="/realAuthSave.json" novalidate="novalidate" enctype="multipart/form-data">
							<fieldset>
						        ...
						        <div class="form-group">
					        		...
					        		<div class="col-sm-8">
					        			...
					        			<div class="idCardItem">
					        				<div>
                            <input type="file" name="file" id="uploadImage1" />上传正面
									        </div>
					        				<img alt="" src="" class="uploadImg" id="uploadImg1" />
					        			</div>
					        			<div class="idCardItem">
					        				<div>
                            <input type="file" name="file" id="uploadImage1" />上传反面
					        				</div>
						        ...
						        <div class="form-group">
						        	<button id="submit" type="submit" class="btn btn-primary col-sm-offset-4" data-loading-text="正在提交"><i class="icon-ok"></i> 提交认证</button>
						        </div>
							</fieldset>
						</form>
					</div>
